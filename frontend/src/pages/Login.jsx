...
//     try {
//       const res = await axios.post('http://localhost:5001/auth/login', {
//         username: email, // giả sử email đăng nhập được xử lý như username
//         password: password,
//       }, {
//         headers: {
//           'CSRF-Token': csrfToken
...
//             <Email onSubmit={handleEmailLogin} loading={loading} />
...
const Login = () => {
  ...
  const [loginStatus, setLoginStatus] = useState('');
  const [statusHolder, setStatusHolder] = useState('message');
  const [showEmailForm, setShowEmailForm] = useState(false); // toggle form
        ...
        <Row>
          <Col lg="6" md="6" sm="12" className="m-auto text-center">
            ...
            <Email
              ...
              loading={loading}
              toggle={() => setShowEmailForm(prev => !prev)}
